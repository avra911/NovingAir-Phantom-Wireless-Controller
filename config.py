...
TUYA_VERSION = float(os.environ["TUYA_VERSION"])

INDOOR_ID = os.environ["INDOOR_ID"]
INDOOR_CID = os.environ["INDOOR_CID"]

OUTDOOR_ID = os.environ["OUTDOOR_ID"]
OUTDOOR_CID = os.environ["OUTDOOR_CID"]

TUYA_CHILD_KEY = os.environ["TUYA_CHILD_KEY"]